...
function validate(input) {
  ...
  } else if (!/^[a-zA-Z]{1,20}$/.test(input.name)) {
    errors.name = "Enter only letters and maximum 20 characters";
  } else if (!input.duration) {
    errors.duration = "You must fill this field";
  } else if (!/^(1[0-2]|[1-9])$/.test(input.duration)) {
    errors.duration = "Enter a number from 1 to 12";
        ...
        <form className="Activity__Form" onSubmit={handleSubmit}>
          ...
          <div className="Form__Input">
            ...
            <input
              ...
              // pattern="[a-zA-Z]{1,20}"
              // title="Enter only letters and maximum 20 characters"
            />
          </div>
          ...
          <div className="Form__Input">
            ...
            <input
              ...
              onChange={handleChange}
              // pattern="[1-9]|1[0-2]"
              // title="Enter a number from 1 to 12"
            />
          </div>
